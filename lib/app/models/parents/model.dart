...
abstract class Model {
  ...
  Media galleryFromJson(Map<String, dynamic> json, String attribute) {
    try {
      Media media = new Media();
      if (json != null && json['gallery'] != null && (json['gallery'] as List).length > 0) {
        media = Media.fromJson(json['gallery'][0]);
      }
      return media;
    } catch (e) {
      throw Exception('Error while parsing ' + attribute + '[' + e.toString() + ']');
  ...
  List<Media> galleryListFromJson(Map<String, dynamic> json, String attribute) {
    try {
      List<Media> medias = [new Media()];
      if (json != null && json['gallery'] != null && (json['gallery'] as List).length > 0) {
        medias = List.from(json['gallery']).map((element) => Media.fromJson(element)).toSet().toList();
      }
      return medias;
    } catch (e) {
      throw Exception('Error while parsing ' + attribute + '[' + e.toString() + ']');
