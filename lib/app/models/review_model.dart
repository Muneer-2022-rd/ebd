...
class Review extends Model {
  ...
  Review.fromJson(Map<String, dynamic> json) {
    ...
    visible = stringFromJson(json, 'visible');
  ...
  @override
  int get hashCode => super.hashCode ^ id.hashCode ^ rate.hashCode ^ review.hashCode ^ visible.hashCode ^ createdAt.hashCode ^ user.hashCode ^ eService.hashCode;
}
