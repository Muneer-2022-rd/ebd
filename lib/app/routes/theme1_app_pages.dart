...
import 'package:emarates_bd/app/middlewares/on_boarding_middelware.dart';
import 'package:emarates_bd/app/middlewares/root_middleware.dart';
import 'package:emarates_bd/app/modules/auth/views/business_information_page2.dart';
import 'package:emarates_bd/app/modules/auth/views/quick_listing_view.dart';
import 'package:emarates_bd/app/modules/e_provider/views/e_provider_reviews.dart';
import 'package:emarates_bd/app/modules/e_service/views/e_service_reviews.dart';
import 'package:emarates_bd/app/modules/home/views/all_cities.dart';
import 'package:emarates_bd/app/modules/home/views/all_featured.dart';
import 'package:emarates_bd/app/modules/home/views/all_newly_added.dart';
import 'package:emarates_bd/app/modules/home/widgets/offerAndnew_services_view.dart';
import 'package:emarates_bd/app/modules/home/widgets/providers_view_all_widget.dart';
import 'package:emarates_bd/app/modules/mail/bindings/mail_binding.dart';
import 'package:emarates_bd/app/modules/mail/views/mail_view.dart';
import 'package:emarates_bd/app/modules/onBoarding/binding/on_boarding_binding.dart';
import 'package:emarates_bd/app/modules/onBoarding/views/on_boarding_view.dart';
import 'package:emarates_bd/app/modules/rating_provider/bindings/rating_binding.dart';
import 'package:emarates_bd/app/modules/rating_provider/views/rating_provider_view.dart';
...
import '../modules/onBoarding/views/clearfiy.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    GetPage(
        ...
        middlewares: [OnBoardingMiddelware()]),
    GetPage(
        name: Routes.ROOT,
        page: () => RootView(),
        binding: RootBinding(),
    ...
    GetPage(
        name: Routes.RATINGProvider,
        page: () => RatingProviderView(),
        binding: RatingProviderBinding(),
        middlewares: [AuthMiddleware()]),
    GetPage(
        name: Routes.CHAT,
        page: () => ChatsView(),
    ...
    GetPage(
        ...
        middlewares: [AuthMiddleware()]),
    GetPage(name: Routes.Mail, page: () => MailView(), binding: MailBinding()),
    GetPage(
        name: Routes.CATEGORY,
        page: () => CategoryView(),
        binding: CategoryBinding()),
    GetPage(
        name: Routes.OFFERANDSERVICES,
        page: () => OfferAndServices(),
        binding: CategoryBinding()),
    GetPage(
        name: Routes.PROVIDERVIEWALL,
        page: () => ProvidersViewAll(),
        binding: CategoryBinding()),
    GetPage(name: Routes.CITY, page: () => CityView(), binding: CityBinding()),
    GetPage(
        name: Routes.EVENTS,
        page: () => EventView(),
    ...
    GetPage(
        ...
        page: () => CategoriesView(),
        binding: CategoryBinding()),
    GetPage(name: Routes.all_cities, page: () => AllCities()),
    GetPage(name: Routes.all_newly_added, page: () => AllNewlyAddedScreen()),
    GetPage(name: Routes.all_featured, page: () => AllFeaturedScreen()),
    GetPage(
        name: Routes.LOGIN,
        page: () => LoginView(),
        binding: AuthBinding(),
    ...
    GetPage(
        name: Routes.QUICKLISTINGBUSINESSINFORMATION,
        page: () => BusinessInformationPage2(),
        binding: AuthBinding(),
        transition: Transition.zoom),
    GetPage(
        ...
        binding: AuthBinding()),
    GetPage(
        name: Routes.QUICK_LISTING,
        page: () => QuickListingView(),
        binding: AuthBinding()),
    GetPage(
    ...
    GetPage(
        ...
        transition: Transition.downToUp),
    GetPage(
        name: Routes.SERVICESREVIEW,
        page: () => EServiceReviews(),
        binding: EServiceBinding(),
        transition: Transition.downToUp),
    GetPage(
    ...
    GetPage(
        name: Routes.PROVIDERSREVIEW,
        page: () => EProviderReviews(),
        binding: EProviderBinding()),
    GetPage(
        name: Routes.PROVIDERSREVIEW,
        page: () => EProviderReviews(),
    ...
    GetPage(
        ...
        binding: EProviderBinding()),
    GetPage(
        name: Routes.E_SERVICE_PROVIDER,
        page: () => EProviderEServicesView(),
        binding: EProviderBinding()),
    GetPage(
        name: Routes.BOOKING,
