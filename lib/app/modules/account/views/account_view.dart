...
class AccountView extends GetView<AccountController> {
  ...
  Widget build(BuildContext context) {
    ...
    print(_currentUser.value.avatar?.thumb);
    var image_user = null;
    if (_currentUser.value.img!.length != 0)
      image_user = 'https://kakdoma.online/admin/public/images/' +
          _currentUser.value.img!;
    print('account');
    print(_currentUser.value.img);
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text(
                              "${_currentUser.value.name} ${_currentUser.value.lname}" ??
                                  '',
