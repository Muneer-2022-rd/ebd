...
import 'package:emarates_bd/app/modules/events/widgets/event_til_widget.dart';
import 'package:emarates_bd/app/modules/events/widgets/event_title_bar_widget.dart';
...
class EventView extends GetView<EventController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        bottomNavigationBar:
            _event.regLink!.isNotEmpty ? buildBottomWidget(_event) : SizedBox(),
                ...
                background: Stack(
                  ...
                  children: <Widget>[
                    Stack(
                      ...
                      children: <Widget>[
                        Hero(
                          tag: controller.heroTag + _event.id!,
              ...
              child: Column(
                ...
                children: [
                  ...
                  EventTilWidget(
                    ...
                    content: Ui.applyHtml(_event.desc!,
                  ...
                  EventTilWidget(
                    title: Text("Place".tr,
                        style: Get.textTheme.subtitle2!
                            .copyWith(color: Get.theme.colorScheme.secondary)),
                    content: Ui.applyHtml(_event.location!,
                        style: Get.textTheme.bodyText1),
                  ),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Get.textTheme.caption!
                              .copyWith(color: Get.textTheme.headline6!.color),
                        ).paddingOnly(top: 10),
  ...
  Widget? buildCarouselSlider(EventsModel _event) {
    Container(
      height: 370,
      child: Hero(
  ...
  // Container buildCarouselBullets(EventsModel _event) {
  //   return Container(
  ...
  EventTitleBarWidget buildEventTitleBarWidget(EventsModel _event) {
          ...
          Row(
            children: [
              ...
              Column(
                children: [
                  Container(
                    child: Text("Start".tr + ": " + _event.startDate!,
                        maxLines: 1,
                        style: Get.textTheme.bodyText2?.merge(
                          TextStyle(
                  ...
                  Container(
                    child: Text("End".tr + ": " + _event.endDate!,
                        maxLines: 1,
                        style: Get.textTheme.bodyText2?.merge(
                          TextStyle(
  ...
  // }
  //
  Widget buildBottomWidget(EventsModel _event) {
    return Container(
        ...
        children: [
          ...
          Expanded(
            child: BlockButtonWidget(
                ...
                color: Get.theme.colorScheme.secondary,
                onPressed: () async {
                  print(controller.event.value.regLink);
                  if (await canLaunch(controller.event.value.regLink!)) {
                    await launch("${controller.event.value.regLink}");
                  } else {}
