...
// import 'package:emarates_bd/app/modules/cities/widgets/services_list_item_widget.dart';

import '../../global_widgets/circular_loading_widget.dart';
import '../controllers/city_controller.dart';
import 'services_list_item_widget.dart';

class ServicesListWidget extends GetView<CityController> {
  ServicesListWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // print( 'service in city...');
    // print( controller.eServices.isEmpty);
    // print( ' _service.addresses.toString()');
