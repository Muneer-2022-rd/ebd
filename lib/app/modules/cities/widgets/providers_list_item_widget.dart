  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        print('_provider');
        print(_provider);
        print('providersListItemWidget - EProvider widget');
        Get.toNamed(Routes.E_PROVIDER, arguments: {'eProvider': _provider, 'heroTag': 'provider_list_item'});
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Column(
              children: [
                Hero(
                  tag: 'provider_list_item' + _provider.id.toString(),
                  child: ClipRRect(
                ...
                //   ),
                // if (!_provider.eProvider.available)
                //   Container(
                //     width: 80,
...
//                   Wrap(
//                     spacing: 5,
//                     children: List.generate(_provider.length, (index) {
//                       return Container(
