...
class ProvidersListWidget extends GetView<CityController> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      primary: false,
      shrinkWrap: true,
      itemCount: controller.providersCity.length,
      itemBuilder: ((_, index) {
        ProviderModel _provider = controller.providersCity.elementAt(index);
                ...
                child: GestureDetector(
                  onTap: () {
                    Get.toNamed(Routes.E_PROVIDER, arguments: {
                      'eProvider': controller.providersCity[index],
                      'heroTag': 'city_list'
                    });
                  },
