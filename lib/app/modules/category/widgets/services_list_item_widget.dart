          ...
          children: [
            Column(
              children: [
                ...
                if (_service.eProvider !=null && _service.eProvider!.available!)
                ...
                children: <Widget>[
                    ...
                    children: [
                      Wrap(
                        ...
                        children: [
                          ...
                          Text(
                            //FROM
                            "от (%s)".trArgs([_service.totalReviews.toString()]),
                  ...
                  Row(
                    children: [
                      ...
                      // ),
                      SizedBox(width: 5),
                      if (_service.addresses!.length > 0)
                      Flexible(
                        child: Text(
                          // TODO eProvider address
                          // _service.eProvider.firstAddress,
                          _service.addresses![0].address!,
                          maxLines: 3,
                          overflow: TextOverflow.ellipsis,
                          softWrap: true,
                          style: Get.textTheme.bodyText1,
