...
class HomeSearchBarWidget extends StatelessWidget implements PreferredSize {
  ...
  GlobalKey? globalKeyTow;

  HomeSearchBarWidget({this.globalKeyOne, this.globalKeyTow});
            ...
            children: <Widget>[
              controller.sharedPrefServices.sharedPreferences!
                  ...
                  : ShowCaseView(
                      ...
                      title: "Search".tr,
                      description: "Find the company you want ..".tr,
                      child: Padding(
                          padding: const EdgeInsets.only(right: 12, left: 0),
                          child: Icon(Icons.search,
                              color: Get.theme.colorScheme.secondary)),
              ...
              GestureDetector(
                ...
                child: controller.sharedPrefServices.sharedPreferences!
                        .containsKey("click show case")
                    ? Container(
                    ...
                    : ShowCaseView(
                        globalKey: globalKeyTow ?? GlobalKey(),
                        title: "Filter".tr,
                        description:
                            "Many filters to help you search for companies".tr,
                        child: Container(
                          padding: const EdgeInsets.only(
                              right: 10, left: 10, top: 10, bottom: 10),
                          decoration: BoxDecoration(
