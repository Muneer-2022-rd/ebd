...
class Ui {
  static GetBar SuccessSnackBar(
      {String title = 'Success', required String message , IconData icon = Icons.check_circle_outline}) {
  ...
  static GetBar ErrorSnackBar(
      {String title = 'Error', required String message, bool longDuration = false , IconData icon = Icons.remove_circle_outline , Function(GetSnackBar snack)? onTap }) {
    ...
    return GetBar(
      ...
      padding: EdgeInsets.symmetric(horizontal: 20, vertical: 18),
      borderRadius: 8,
      duration: longDuration  ?   Duration(days:2) : Duration(seconds: 5),
    );
  }
  ...
  static GetBar NoInternetBar(){
    return Ui.ErrorSnackBar(
        message:
        "There is no internet connection... \nClick to go to Wi-Fi settings"
            .tr,
        longDuration: true,
  ...
  static GetBar SuccessInternetBar(){
    return Ui.SuccessSnackBar(
        message:
  ...
  static InputDecoration getInputDecoration({
    ...
    return InputDecoration(
      ...
      prefixIcon: iconData != null
          ? Icon(iconData, color: Get.theme.focusColor).marginOnly(
              right: Get.locale.toString() == "en" ? 14 : 0,
              left: Get.locale.toString() == "ar" ? 14 : 0)
          : SizedBox(),
